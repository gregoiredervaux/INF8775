...
class LocalNonOptimise(Algorithme.Algorithme):

    def __init__(self):
        super().__init__()
        self.name = "localNonOptimise"
    ...
    def chgmtSolution(self, data, solution, solution_allowed, rev, capacite, popIndex, targetIndex):
        ...
        :param data: tableau initial regroupant les solutions et revenus associés
        :param solution: array regroupant les solutions envisagées
        :param solution_allowed: array regroupant les elements envisageable
        :param rev: revenu de la solution
        :param capacite: capacité de la solution
        :param popIndex: array vide ou contenant index
        :param targetIndex: array vide ou contenant un index
        :return: void
        """
